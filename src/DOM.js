    ...
    createDOMelement(
      ...
      createDOMelement(
        ...
        createDOMelement('textarea', {
          name: 'description', id: 'description', cols: '30', rows: '6',
        }, ''),
  ...
  const header = createDOMelement(
    ...
    createDOMelement(
      ...
      createDOMelement('input', {
        type: 'text', placeholder: 'search', name: 'searchbar', id: 'searchbar',
      }, ''),
    ),
  );
  const main = createDOMelement(
    ...
    createDOMelement(
      ...
      createDOMelement(
        ...
        createDOMelement(
          'div',
          { class: 'tabva', name: 'project-tabs' },
          createDOMelement('button', { class: 'tablinks', id: 'view-all' }, 'View All'),
        ),
        createDOMelement(
          'div',
          { class: 'tab', name: 'project-tabs' },
        ),
      ),
      createDOMelement(
        'form',
        { class: 'new-project-form', id: 'new-project-form' },
